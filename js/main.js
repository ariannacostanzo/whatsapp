...
const app = createApp ({
    ...
    data() {
        return {
            ...
            isShown: false,
            isWriting: false,
            replies: ['Ok', 'ma stai bene?', 'ho conosciuto un ragazzo troppo simpatico', 'come stai?', 'Berthold mi ha scritto', 'tutto ok?', 'ok...', 'Va bene', 'Boh ok','💓💓💓','💛💛','Veramente?', 'Non va bene', 'okok', 'ma che dici?', 'non voglio parlare con te adesso', '🌞','😄','sei insopportabile', 'Mi presti il tuo equipaggiamento?', '🤣🤣','andiamo a Marley?' ,'🥰🥰🥰🥰🥰🥰🥰', 'ti va una patata?', 'ho fame', '😋😋😋😋😋😋😋','come si chiama quella bambina fastidiosa di Marley?', 'ci vediamo al distretto di Trost?','😑😑😑😑😑😑😑','☹️☹️☹️☹️☹️☹️☹️☹️☹️☹️'],
